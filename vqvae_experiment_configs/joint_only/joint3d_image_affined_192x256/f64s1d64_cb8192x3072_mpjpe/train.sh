...
EXP_NAME=joint_only/joint3d_image_affined_192x256/f64s1d64_cb8192x3072_mpjpe
CONFIG=vqvae_experiment_configs/joint_only/joint3d_image_affined_192x256/f64s1d64_cb8192x3072_mpjpe/config.yaml
LOG=vqvae_experiment_configs/joint_only/joint3d_image_affined_192x256/f64s1d64_cb8192x3072_mpjpe/train.log


if [ "$mode" = "test" ]; then
    RESUME_PATH="vqvae_experiment/joint_only/joint3d_image_affined_192x256/f64s1d64_cb8192x3072_mpjpe/models/checkpoint_epoch_346_step_260000"
