...
vision_guidance_fuse=cross_attn

EXP_NAME="joint_and_image/joint3d_image_affined_192x256/f16s1d16_cb8192x2048_mpjpe_Tdown1-2/hrFix_lvl3_crsAttn"
CONFIG="vqvae_experiment_configs/joint_and_image/joint3d_image_affined_192x256/f16s1d16_cb8192x2048_mpjpe_Tdown1-2/hrFix_lvl3_crsAttn/config.yaml"
LOG="vqvae_experiment_configs/joint_and_image/joint3d_image_affined_192x256/f16s1d16_cb8192x2048_mpjpe_Tdown1-2/hrFix_lvl3_crsAttn/train.log"

if [ "$mode" = "test" ]; then
    RESUME_PATH="vqvae_experiment/joint_and_image/joint3d_image_affined_192x256/f16s1d16_cb8192x2048_mpjpe_Tdown1-2/hrFix_lvl3_crsAttn/models/checkpoint_epoch_185_step_140000"
...
if [ "$mode" = "debug" ]; then
    ...
    CUDA_VISIBLE_DEVICES=4,5 \
        nohup \
        accelerate launch --num_processes 2 --main_process_port 29250 \
        train_vqvae_new.py \
        --batch_size ${BATCH_SIZE} \
        --config ${CONFIG} \
        --data_mode ${DATA_MODE} \
