...
if [ "$mode" = "test" ]; then
    RESUME_PATH=vqvae_experiment/joint_and_image/joint3d_image_affined_192x256/f1s1d1_cb4096x2048_mpjpe/hrFix_lvl3_ratio0.5/models/checkpoint_epoch_42_step_500000
