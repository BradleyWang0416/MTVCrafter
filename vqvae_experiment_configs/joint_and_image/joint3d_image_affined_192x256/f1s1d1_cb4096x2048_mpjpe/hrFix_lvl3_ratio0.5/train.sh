...
EXP_NAME=joint_and_image/joint3d_image_affined_192x256/f1s1d1_cb4096x2048_mpjpe/hrFix_lvl3_ratio0.5
CONFIG=vqvae_experiment_configs/joint_and_image/joint3d_image_affined_192x256/f1s1d1_cb4096x2048_mpjpe/hrFix_lvl3_ratio0.5/config.yaml
LOG=vqvae_experiment_configs/joint_and_image/joint3d_image_affined_192x256/f1s1d1_cb4096x2048_mpjpe/hrFix_lvl3_ratio0.5/train.log

if [ "$mode" = "test" ]; then
    RESUME_PATH=vqvae_experiment/joint_and_image/joint3d_image_affined_192x256/f16s1d16_cb4096x2048_mpjpe/hrFix_lvl3_ratio0.5/models/checkpoint_epoch_53_step_320000
