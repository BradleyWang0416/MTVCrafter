...
EXP_NAME=MultiDatasets/Amass_H36m/joint_only/joint3d_cam_rootrel_meter/f16s1d16_cb8192x3072_mpjpe_Tdown1-2/
CONFIG=vqvae_experiment_configs/MultiDatasets/Amass_H36m/joint_only/joint3d_cam_rootrel_meter/f16s1d16_cb8192x3072_mpjpe_Tdown1-2/config.yaml
LOG=vqvae_experiment_configs/MultiDatasets/Amass_H36m/joint_only/joint3d_cam_rootrel_meter/f16s1d16_cb8192x3072_mpjpe_Tdown1-2/train.log

if [ "$mode" = "test" ]; then
    RESUME_PATH="vqvae_experiment/MultiDatasets/Amass_H36m/joint_only/joint3d_cam_rootrel_meter/f16s1d16_cb8192x3072_mpjpe_Tdown1-2/models/checkpoint_epoch_73_step_500000"
